// This is a tutorial from https://codeburst.io/build-a-weather-website-in-30-minutes-with-node-js-express-openweather-a317f904897b
...
app.get('/', function (req, res) {
  res.render('index', {weather: null, error: null, weatherIcon: null, cities: null});
});
...
app.post('/', function (req, res) {
  ...
  function getCity(citiesWeather) {
    request(url, function (err, response, body) {
      if(err){
        ...
        if(weather.main == undefined){
          ...
          res.render('index', {weather: weatherText, error: null, weatherIcon: weatherIcon, cities: citiesWeather});
        }
      }
    });
  };
